...
public class GOTFixer {
	...
	public static void affixWaypointLocations(GOTBiome biome) {
		...
		slot++;
		f[slot] = new GOTStructureAsshaiCity(biome, 0.0f);
		f[slot].affix(GOTWaypoint.Asshai.info(0, 0, 2));
		slot++;
		...
		slot++;
		f[slot] = new GOTStructureYiTiCity(biome, 0.0f).setIsTower();
		f[slot].affix(GOTWaypoint.FiveForts1, GOTWaypoint.FiveForts2, GOTWaypoint.FiveForts3, GOTWaypoint.FiveForts4, GOTWaypoint.FiveForts5.info(0, 0, 3));
		slot++;
		f[slot] = new GOTStructureGhiscarCity(biome, 0.0f).setIsColony();
		f[slot].affix(GOTWaypoint.IsleOfWhips, GOTWaypoint.BarterBeach, GOTWaypoint.Gogossos, GOTWaypoint.Gorosh, GOTWaypoint.Zamettar.info(0, -1, 2));
		slot++;
		f[slot] = new GOTStructureGhiscarCity(biome, 0.0f).setIsTown();
		f[slot].affix(GOTWaypoint.Astapor.info(-1, 0, 1), GOTWaypoint.Meereen.info(0, -1, 2), GOTWaypoint.NewGhis.info(0, 0, 0), GOTWaypoint.Yunkai.info(-1, 0, 1));
		slot++;
		f[slot] = new GOTStructureGhiscarCity(biome, 0.0f).setIsPyramidShiftX();
		f[slot].affix(GOTWaypoint.Astapor.info(-2, 0, 0), GOTWaypoint.NewGhis.info(-2, 0, 0), GOTWaypoint.Yunkai.info(-2, 0, 0));
		slot++;
		f[slot] = new GOTStructureGhiscarCity(biome, 0.0f).setIsPyramidShiftZ();
		f[slot].affix(GOTWaypoint.Meereen.info(0, -2, 0));
		slot++;
		...
		slot++;
		f[slot] = new GOTStructureIbbenVillage(biome, 0.0f);
		f[slot].affix(GOTWaypoint.IbNor, GOTWaypoint.IbSar, GOTWaypoint.NewIbbish, GOTWaypoint.PortOfIbben);
		slot++;
		...
		slot++;
		f[slot] = new GOTStructureJogosVillage(biome, 0.0f).setIsBig();
		f[slot].affix(GOTWaypoint.Hojdbaatar);
		slot++;
		f[slot] = new GOTStructureLhazarVillage(biome, 0.0f).setIsTown();
		f[slot].affix(GOTWaypoint.Hesh.info(1, 0, 3), GOTWaypoint.Kosrak.info(1, 0, 1), GOTWaypoint.Lhazosh.info(-1, 0, 1));
		slot++;
		f[slot] = new GOTStructureLorathCity(biome, 0.0f).setIsTown();
		f[slot].affix(GOTWaypoint.Lorath, GOTWaypoint.Morosh);
		slot++;
		f[slot] = new GOTStructureLysCity(biome, 0.0f).setIsTown();
		f[slot].affix(GOTWaypoint.Lys);
		slot++;
		f[slot] = new GOTStructureYiTiCity(biome, 0.0f).setIsWall(true);
		f[slot].affix(GOTWaypoint.Anjiang);
		slot++;
		f[slot] = new GOTStructureMossovyVillage(biome, 0.0f);
		f[slot].affix(GOTWaypoint.Kuurulgan, GOTWaypoint.SuudanKorkuu, GOTWaypoint.KanduuBet, GOTWaypoint.Tashtoo, GOTWaypoint.Bashkaruuchu, GOTWaypoint.AzuuKan, GOTWaypoint.Kujruk, GOTWaypoint.Korkunuchtuu, GOTWaypoint.NymduuOoz, GOTWaypoint.Azhydaar, GOTWaypoint.AkShaar, GOTWaypoint.SuuNym, GOTWaypoint.ShyluunUusu, GOTWaypoint.Kadar, GOTWaypoint.Nefer, GOTWaypoint.KDath);
		slot++;
		f[slot] = new GOTStructureMyrCity(biome, 0.0f).setIsTown();
		f[slot].affix(GOTWaypoint.Myr.info(-1, 0, 1));
		slot++;
		...
		slot++;
		f[slot] = new GOTStructurePentosCity(biome, 0.0f).setIsTown();
		f[slot].affix(GOTWaypoint.Pentos.info(-1, 0, 1));
		slot++;
		...
		slot++;
		f[slot] = new GOTStructureQohorCity(biome, 0.0f).setIsTown();
		f[slot].affix(GOTWaypoint.Qohor.info(0, -1, 2));
		slot++;
		...
		slot++;
		f[slot] = new GOTStructureYiTiCity(biome, 0.0f).setIsWall(false);
		f[slot].affix(GOTWaypoint.Jianmen, GOTWaypoint.Anguo, GOTWaypoint.Dingguo, GOTWaypoint.Pinnu, GOTWaypoint.Pingjiang, GOTWaypoint.Wude, GOTWaypoint.Wusheng, GOTWaypoint.Zhenguo, GOTWaypoint.Lungmen);
		slot++;
		...
		slot++;
		f[slot] = new GOTStructureQarthCity(biome, 0.0f).setIsCastle();
		f[slot].affix(GOTWaypoint.Teriman, GOTWaypoint.Batargas, GOTWaypoint.Karimagar);
		slot++;
